...
Para todos los ejercicios es se usan los mismo comandos para verificar el correcto funcionamiento:
...
En resumen vamos a definir los mensajes de esta manera:
```go
const (
   MsgTypeBet             = 0x01
